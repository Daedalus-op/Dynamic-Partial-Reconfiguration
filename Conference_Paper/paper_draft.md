...
![CFU Playground interface architecture — the standardised handshake between VexRiscv and the Custom Function Unit.](../Report/assets/CFU_Architecture.png)
