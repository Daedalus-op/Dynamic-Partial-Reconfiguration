...
HD_PWD='/home/xubundadu/Desktop/Capstone/dfx_playground/dfx_playground.runs/child_0_impl_2'
cd "$HD_PWD"
...
EAStep vivado -log top_tut.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_tut.tcl -notrace
