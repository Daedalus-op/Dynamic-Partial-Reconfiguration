...
vlog -work xpm  -incr "+incdir+../../../../digilent_arty.gen/sources_1/ip/ila_1/hdl/verilog" -l xpm -l xil_defaultlib \
...
vlog -work xil_defaultlib  -incr -v2k5 "+incdir+../../../../digilent_arty.gen/sources_1/ip/ila_1/hdl/verilog" -l xpm -l xil_defaultlib \
