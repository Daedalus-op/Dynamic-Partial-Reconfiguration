...
design_libs=(xpm axis_infrastructure_v1_1_1 axis_register_slice_v1_1_31 axi_infrastructure_v1_1_0 axi_register_slice_v2_1_31 dfx_decoupler_v1_0_9 xil_defaultlib)
...
compile()
{
  ...
  vlogan -work axis_register_slice_v1_1_31 $vlogan_opts +v2k +incdir+"../../../ipstatic/hdl" \
  ...
  vlogan -work axi_register_slice_v2_1_31 $vlogan_opts +v2k +incdir+"../../../ipstatic/hdl" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.dfx_decoupler_0 xil_defaultlib.glbl -o dfx_decoupler_0_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./dfx_decoupler_0_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key dfx_decoupler_0_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc dfx_decoupler_0_simv.daidir vcs_lib c.obj)
