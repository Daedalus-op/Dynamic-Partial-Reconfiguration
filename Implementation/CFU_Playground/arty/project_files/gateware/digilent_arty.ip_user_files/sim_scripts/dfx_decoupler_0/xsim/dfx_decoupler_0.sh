...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L axis_infrastructure_v1_1_1 -L axis_register_slice_v1_1_31 -L axi_infrastructure_v1_1_0 -L axi_register_slice_v2_1_31 -L dfx_decoupler_v1_0_9 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot dfx_decoupler_0 xil_defaultlib.dfx_decoupler_0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim dfx_decoupler_0 -key {Behavioral:sim_1:Functional:dfx_decoupler_0} -tclbatch cmd.tcl -protoinst "protoinst_files/design_1.protoinst" -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/jsp/Storage/Vivado/2024.1/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb dfx_decoupler_0.wdb xsim.dir libdpi.so)
