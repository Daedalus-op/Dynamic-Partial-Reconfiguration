...
#
# Script generated by Vivado on Fri Nov 28 01:17:07 IST 2025
# SW Build 5076996 on Wed May 22 18:36:09 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : dfx_decoupler_0.sh
...
#
# Usage        : dfx_decoupler_0.sh
#                dfx_decoupler_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                dfx_decoupler_0.sh [-reset_run]
#                dfx_decoupler_0.sh [-reset_log]
#                dfx_decoupler_0.sh [-help]
#
...
#                script (type 'dfx_decoupler_0.sh -help' for more information).
#
...
design_libs_elab="-libname xpm -libname axis_infrastructure_v1_1_1 -libname axis_register_slice_v1_1_31 -libname axi_infrastructure_v1_1_0 -libname axi_register_slice_v2_1_31 -libname dfx_decoupler_v1_0_9 -libname xil_defaultlib -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm axis_infrastructure_v1_1_1 axis_register_slice_v1_1_31 axi_infrastructure_v1_1_0 axi_register_slice_v2_1_31 dfx_decoupler_v1_0_9 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "dfx_decoupler_0.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./dfx_decoupler_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  ...
  xmvlog -work axis_register_slice_v1_1_31 $xmvlog_opts +incdir+"../../../ipstatic/hdl" \
  ...
  xmvlog -work axi_register_slice_v2_1_31 $xmvlog_opts +incdir+"../../../ipstatic/hdl" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.dfx_decoupler_0 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.dfx_decoupler_0 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log dfx_decoupler_0_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./dfx_decoupler_0.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: dfx_decoupler_0.sh [-help]\n\
Usage: dfx_decoupler_0.sh [-step]\n\
Usage: dfx_decoupler_0.sh [-lib_map_path]\n\
Usage: dfx_decoupler_0.sh [-reset_run]\n\
Usage: dfx_decoupler_0.sh [-reset_log]\n\
Usage: dfx_decoupler_0.sh [-keep_index]\n\
Usage: dfx_decoupler_0.sh [-noclean_files]\n\n\
