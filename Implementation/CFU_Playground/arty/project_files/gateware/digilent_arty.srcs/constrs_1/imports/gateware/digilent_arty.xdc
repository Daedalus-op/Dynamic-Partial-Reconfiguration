...
set_property IOSTANDARD LVCMOS33 [get_ports cfu_reset]

# decouple_switch:0 (switch)
set_property PACKAGE_PIN A8 [get_ports decouple_switch]
set_property IOSTANDARD LVCMOS33 [get_ports decouple_switch]

# buttonsarty a7 aaaasadadsaasdasd
