...
// Command     : write_verilog -force -mode synth_stub -rename_top dfx_decoupler_0 -prefix
//               dfx_decoupler_0_ dfx_decoupler_0_stub.v
...
module dfx_decoupler_0(s_cfu_inputs_cmd_valid, 
  ...
  s_cfu_inputs_reset, rp_cfu_inputs_reset, cfu_inputs_ref_clk, 
  cfu_inputs_decouple_status, s_cfu_outputs_cmd_ready, rp_cfu_outputs_cmd_ready, 
  s_cfu_outputs_rsp_valid, rp_cfu_outputs_rsp_valid, 
  s_cfu_outputs_rsp_payload_outputs_0, rp_cfu_outputs_rsp_payload_outputs_0, 
  s_cfu_outputs_cfu_id, rp_cfu_outputs_cfu_id, decouple, decouple_status, decouple_ref_clk)
/* synthesis syn_black_box black_box_pad_pin="s_cfu_inputs_cmd_valid[0:0],rp_cfu_inputs_cmd_valid[0:0],s_cfu_inputs_cmd_payload_function_id[9:0],rp_cfu_inputs_cmd_payload_function_id[9:0],s_cfu_inputs_cmd_payload_inputs_0[31:0],rp_cfu_inputs_cmd_payload_inputs_0[31:0],s_cfu_inputs_cmd_payload_inputs_1[31:0],rp_cfu_inputs_cmd_payload_inputs_1[31:0],s_cfu_inputs_rsp_ready[0:0],rp_cfu_inputs_rsp_ready[0:0],s_cfu_inputs_reset[0:0],rp_cfu_inputs_reset[0:0],cfu_inputs_decouple_status,s_cfu_outputs_cmd_ready[0:0],rp_cfu_outputs_cmd_ready[0:0],s_cfu_outputs_rsp_valid[0:0],rp_cfu_outputs_rsp_valid[0:0],s_cfu_outputs_rsp_payload_outputs_0[31:0],rp_cfu_outputs_rsp_payload_outputs_0[31:0],s_cfu_outputs_cfu_id[2:0],rp_cfu_outputs_cfu_id[2:0],decouple,decouple_status" */
