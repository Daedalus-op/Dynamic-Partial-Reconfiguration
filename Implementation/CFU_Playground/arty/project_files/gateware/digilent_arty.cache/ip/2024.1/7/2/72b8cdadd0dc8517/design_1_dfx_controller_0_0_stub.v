...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(m_axi_mem_araddr, m_axi_mem_arlen, 
  ...
  vsm_vs_compute_sw_shutdown_req, vsm_vs_compute_sw_startup_req, cap_req, cap_gnt, cap_rel, 
...
/* synthesis syn_force_seq_prim="icap_clk" */;
  ...
  output vsm_vs_compute_sw_shutdown_req;
  output vsm_vs_compute_sw_startup_req;
  output cap_req;
  input cap_gnt;
  input cap_rel;
