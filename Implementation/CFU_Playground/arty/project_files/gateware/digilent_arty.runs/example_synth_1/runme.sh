...
HD_PWD='/home/jsp/Storage/CFU-Playground/soc/build/digilent_arty.example_cfu/gateware/digilent_arty.runs/example_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cfu_compute.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cfu_compute.tcl
