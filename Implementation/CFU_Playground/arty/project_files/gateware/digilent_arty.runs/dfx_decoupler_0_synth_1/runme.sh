...
HD_PWD='/home/jsp/Storage/CFU-Playground/soc/build/digilent_arty.example_cfu/gateware/digilent_arty.runs/dfx_decoupler_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dfx_decoupler_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dfx_decoupler_0.tcl
