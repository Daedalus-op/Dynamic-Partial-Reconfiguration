...
HD_PWD='/home/jsp/Storage/CFU-Playground/soc/build/digilent_arty.example_cfu/gateware/digilent_arty.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_arty_cfu.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_arty_cfu.tcl
