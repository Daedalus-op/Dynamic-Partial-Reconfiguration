...
#
# Script generated by Vivado on Wed Nov 05 06:54:59 IST 2025
# SW Build 5076996 on Wed May 22 18:36:09 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : cfu_decoupler.sh
...
#
# Usage        : cfu_decoupler.sh
#                cfu_decoupler.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                cfu_decoupler.sh [-reset_run]
#                cfu_decoupler.sh [-reset_log]
#                cfu_decoupler.sh [-help]
#
...
#                script (type 'cfu_decoupler.sh -help' for more information).
#
...
design_libs_elab="-libname xilinx_vip -libname xpm -libname axis_infrastructure_v1_1_1 -libname axis_register_slice_v1_1_31 -libname axi_infrastructure_v1_1_0 -libname axi_register_slice_v2_1_31 -libname dfx_decoupler_v1_0_9 -libname xil_defaultlib -libname xilinx_vip -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xilinx_vip xpm axis_infrastructure_v1_1_1 axis_register_slice_v1_1_31 axi_infrastructure_v1_1_0 axi_register_slice_v2_1_31 dfx_decoupler_v1_0_9 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "cfu_decoupler.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./cfu_decoupler.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"../../../ipstatic/hdl" +incdir+"/home/jsp/Storage/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../ipstatic/hdl" +incdir+"/home/jsp/Storage/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  xmvlog -work axis_infrastructure_v1_1_1 $xmvlog_opts +incdir+"../../../ipstatic/hdl" +incdir+"/home/jsp/Storage/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../ipstatic/hdl/axis_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axis_register_slice_v1_1_31 $xmvlog_opts +incdir+"../../../ipstatic/hdl" +incdir+"/home/jsp/Storage/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../ipstatic/hdl/axis_register_slice_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_infrastructure_v1_1_0 $xmvlog_opts +incdir+"../../../ipstatic/hdl" +incdir+"/home/jsp/Storage/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../ipstatic/hdl/axi_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_register_slice_v2_1_31 $xmvlog_opts +incdir+"../../../ipstatic/hdl" +incdir+"/home/jsp/Storage/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../ipstatic/hdl/axi_register_slice_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvhdl -work dfx_decoupler_v1_0_9 -V93 $xmvhdl_opts \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.cfu_decoupler xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.cfu_decoupler -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log cfu_decoupler_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./cfu_decoupler.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: cfu_decoupler.sh [-help]\n\
Usage: cfu_decoupler.sh [-step]\n\
Usage: cfu_decoupler.sh [-lib_map_path]\n\
Usage: cfu_decoupler.sh [-reset_run]\n\
Usage: cfu_decoupler.sh [-reset_log]\n\
Usage: cfu_decoupler.sh [-keep_index]\n\
Usage: cfu_decoupler.sh [-noclean_files]\n\n\
