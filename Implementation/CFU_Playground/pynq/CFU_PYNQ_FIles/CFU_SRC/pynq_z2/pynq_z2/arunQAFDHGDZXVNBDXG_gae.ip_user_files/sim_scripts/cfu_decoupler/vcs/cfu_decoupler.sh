...
design_libs=(xilinx_vip xpm axis_infrastructure_v1_1_1 axis_register_slice_v1_1_31 axi_infrastructure_v1_1_0 axi_register_slice_v2_1_31 dfx_decoupler_v1_0_9 xil_defaultlib)
...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"../../../ipstatic/hdl" +incdir+"/home/jsp/Storage/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../ipstatic/hdl" +incdir+"/home/jsp/Storage/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  vlogan -work axis_infrastructure_v1_1_1 $vlogan_opts +v2k +incdir+"../../../ipstatic/hdl" +incdir+"/home/jsp/Storage/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../ipstatic/hdl/axis_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axis_register_slice_v1_1_31 $vlogan_opts +v2k +incdir+"../../../ipstatic/hdl" +incdir+"/home/jsp/Storage/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../ipstatic/hdl/axis_register_slice_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axi_infrastructure_v1_1_0 $vlogan_opts +v2k +incdir+"../../../ipstatic/hdl" +incdir+"/home/jsp/Storage/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../ipstatic/hdl/axi_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axi_register_slice_v2_1_31 $vlogan_opts +v2k +incdir+"../../../ipstatic/hdl" +incdir+"/home/jsp/Storage/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../ipstatic/hdl/axi_register_slice_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vhdlan -work dfx_decoupler_v1_0_9 $vhdlan_opts \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.cfu_decoupler xil_defaultlib.glbl -o cfu_decoupler_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./cfu_decoupler_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key cfu_decoupler_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc cfu_decoupler_simv.daidir vcs_lib c.obj)
