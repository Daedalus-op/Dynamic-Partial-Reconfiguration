...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot ila xil_defaultlib.ila xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim ila -key {Behavioral:sim_1:Functional:ila} -tclbatch cmd.tcl -protoinst "protoinst_files/system.protoinst" -log simulate.log
}
