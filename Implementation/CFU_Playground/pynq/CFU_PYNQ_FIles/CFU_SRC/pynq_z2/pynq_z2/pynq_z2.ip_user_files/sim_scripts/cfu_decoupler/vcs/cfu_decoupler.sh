...
design_libs=(axis_infrastructure_v1_1_1 axis_register_slice_v1_1_33 axi_infrastructure_v1_1_0 axi_register_slice_v2_1_33 dfx_decoupler_v1_0_11 xil_defaultlib)
...
compile()
{
  ...
  vlogan -work axis_register_slice_v1_1_33 $vlogan_opts +v2k +incdir+"../../../ipstatic/hdl" \
  ...
  vlogan -work axi_register_slice_v2_1_33 $vlogan_opts +v2k +incdir+"../../../ipstatic/hdl" \
  "../../../ipstatic/hdl/axi_register_slice_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vhdlan -work dfx_decoupler_v1_0_11 $vhdlan_opts \
