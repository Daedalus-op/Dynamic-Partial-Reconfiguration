...
export RDI_DATADIR="/work/Vivado/2024.2/data"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L axis_infrastructure_v1_1_1 -L axis_register_slice_v1_1_33 -L axi_infrastructure_v1_1_0 -L axi_register_slice_v2_1_33 -L dfx_decoupler_v1_0_11 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot cfu_decoupler xil_defaultlib.cfu_decoupler xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim cfu_decoupler -key {Behavioral:sim_1:Functional:cfu_decoupler} -tclbatch cmd.tcl -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/work/Vivado/2024.2/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb cfu_decoupler.wdb xsim.dir libdpi.so)
