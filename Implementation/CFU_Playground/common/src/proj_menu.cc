...
void do_donut_grid_cfu_op0(void) {
...
// Test template instruction
void do_donut_grid_cfu_op1(void) {
  puts("\nExercise Donut CFU Op1\n");
  printf("a   b-->");
  for (int b = -3; b < 4; b++) {
    printf("%8d", b);
  }
...
// Test template instruction
void do_donut_exercise_cfu_op1(void) {
  puts("\nExercise Donut CFU Op1\n");
  int count = 0;
...
// Test template instruction
void do_example_exercise_cfu_op(void) {
  puts("\nExercise Example CFU Op0 aka ADD\n");
  int count = 0;
  for (int a = -0x71234567; a < 0x68000000; a += 0x10012345) {
    for (int b = -0x7edcba98; b < 0x68000000; b += 0x10770077) {
      int cfu = cfu_op0(0, a, b);
